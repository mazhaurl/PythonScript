...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(370, 479)
        Form.setMinimumSize(QSize(370, 479))
        Form.setMaximumSize(QSize(370, 479))
        self.gridLayoutWidget = QWidget(Form)
        self.gridLayoutWidget.setObjectName(u"gridLayoutWidget")
        self.gridLayoutWidget.setGeometry(QRect(10, 90, 351, 371))
...
"")
        ...
        self.widget.setGeometry(QRect(10, 40, 351, 42))
        ...
        self.pushButton_Plate_17 = QPushButton(self.widget)
...
class md_backdrop(QWidget, Ui_Form):
 ...
 #Custom  
    def copy_from_user(self):
       ...
       bd_node['label'].setValue(self.textEdit.toPlainText())
...
def md_backdrop_go():
    md_backdrop_go.md_backdrop = md_backdrop()
    md_backdrop_go.md_backdrop.show()
